          ...
          <div className="col-lg-12">
            <div className="contest-wrapper">
              <div className="contest-wrapper__header pt-120">
                <h2 className="contest-wrapper__title">Último Sorteio</h2>
                <ul
                ...
                >
                  <li className="nav-item" role="presentation">
                    ...
                    >
                      <span className="icon-thumb">
                        <Image src={winner_tab_1} alt="vencedor guia 1" />
                      </span>
                  ...
                  <li className="nav-item" role="presentation">
                    ...
                    >
                      <span className="icon-thumb">
                        <Image src={winner_tab_2} alt="vencedor guia 2" />
                      </span>
                      <span>Bicicleta</span>
                    </button>
                  </li>
                  <li className="nav-item" role="presentation">
                    ...
                    >
                      <span className="icon-thumb">
                        <Image src={winner_tab_3} alt="vencedor guia 3" />
                      </span>
                      <span>Relógio</span>
                    </button>
                  </li>
                  <li className="nav-item" role="presentation">
                    ...
                    >
                      <span className="icon-thumb">
                        <Image src={winner_tab_4} alt="vencedor guia 4" />
                      </span>
                      <span>Notebook</span>
                    </button>
                  </li>
                  <li className="nav-item" role="presentation">
                    ...
                    >
                      <span className="icon-thumb">
                        <Image src={winner_tab_5} alt="vencedor guia 5" />
                      </span>
                      <span>Dinheiro</span>
                    </button>
                  </li>
                ...
                <div className="row contest-filter-wrapper justify-content-center mt-30 mb-none-30">
                  ...
                  <div className="col-lg-3 mb-30">
                    <div className="rang-slider">
                      <span className="caption">Preço do Bilhete</span>

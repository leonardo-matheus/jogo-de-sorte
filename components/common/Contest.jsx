          ...
          <div className="col-lg-8">
            <div className="section-header text-center">
              <span className="section-sub-title">
                Tente sua chance de ganhar
              </span>
              <h2 className="section-title">Sorteio atual</h2>
              <p>
              Os participantes compram tickets e são sorteados lotes para determinar os vencedores.
              </p>
            </div>
          </div>
        </div>
